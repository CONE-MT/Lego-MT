            ...
            for i, hyps in enumerate(hypos):
                ...
                for hypo in hyps[:1]:
                    ...
                    if content_detection_flag:
                        ...
                        if suggestion == "block":
                            text = "您输入的内容中存在某些词汇，触发了阿里云的敏感词检测，建议您重新输入。若有误触情况，可联系cone@x-venture.tech寻求帮助~\nThere are certain words in the content you entered, which triggered Alibaba Cloud's sensitive word detection. We recommend that you re-enter. If there is a mistake, please contact cone@x-venture.tech for help~"
